...
This project is licensed under the Apache License 2.0, like the rest of the HiveMind stack. Basically, do whatever you want, but don’t sue us when your HiveMind becomes sentient and decides to unionize.
